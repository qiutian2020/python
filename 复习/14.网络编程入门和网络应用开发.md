...
def main():
    ...
    server.bind(('192.168.1.2', 6789))       # 在对应的服务器上运行，如果没有，报OSError: [Errno 49] Can't assign requested address
    # 3.开启监听 - 监听客户端连接到服务器
    # 参数512可以理解为连接队列的大小
    server.listen(512)
    print('服务器启动开始监听...')
...
<img width="555" alt="image" src="https://github.com/qiutian2020/python/assets/66943119/8384bc63-4125-47ac-becc-6fa69fb5c598">
